...
public class CouponInquiryParser
{
  ...
  public StringBuilder getCouponInquiry(TwilightJsonObject twilightJsonObject){
    StringBuilder builder = new StringBuilder();
    builder = this.processCouponInquiry2AA7(twilightJsonObject);
    logger.info(builder);
    return builder;
  }
  
  private StringBuilder processCouponInquiry2AA7(TwilightJsonObject twilightJsonObject)
  {
    ...
    final Map<String, String> couponInquiryMap = twilightJsonObject.getParameters();
