...
public class FileInquiryParser
{
  ...
  public StringBuilder getFileInquiry(TwilightJsonObject twilightJsonObject){
    StringBuilder builder = new StringBuilder();
    builder = this.processFileInquiry(twilightJsonObject);
    logger.info(builder);
    return builder;
  }
  
  private StringBuilder processFileInquiry(TwilightJsonObject twilightJsonObject)
  {
    String indicator = "D3";
    String fileName = StringUtils.EMPTY;
    String paddedString = StringUtils.EMPTY;
    
    final Map<String, String> fileInquiryMap = twilightJsonObject.getParameters();
