...
import com.searshc.mercy.validation.command.*;
  ...
  public void setLineItems(List<LineItem> lineItems)
  {
    ...
    try
    {
      if(lineItems != null)
      {
        ...
        {
          LineItemValidator lineItemValidator = mapper.readValue(mapper.writeValueAsString(lineItems.get(i)), com.searshc.mercy.validation.LineItemValidator.class);
